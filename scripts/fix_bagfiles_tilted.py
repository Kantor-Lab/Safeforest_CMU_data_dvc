...
def main(args):
    ...
    periods = {
        ...
        '/dji_sdk/acceleration_ground_fused': 0.009139598,
        '/dji_sdk/angular_velocity_fused': 0.00916204,
        '/dji_sdk/attitude': 0.009155162,
        '/dji_sdk/battery_state': 0.182715147,
        '/dji_sdk/flight_status': 0.01832643,
        '/dji_sdk/gps_health': 0.018321058,
        '/dji_sdk/gps_position': 0.018334158,
        '/dji_sdk/imu': 0.002291612,
        '/dji_sdk/rtk_info_position':0.216309756,
        '/dji_sdk/rtk_info_yaw': 0.183486239,
        '/dji_sdk/rtk_position': 0.216309756,
        '/dji_sdk/rtk_velocity': 0.183486239,
        '/dji_sdk/rtk_yaw':0.183486239,
        '/dji_sdk/velocity':0.018335839,
    }
